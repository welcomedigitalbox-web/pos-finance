...
export default function FinanceAccountsPage() {
  ...
  return (
    <div className="pt-4">
      ...
      {/* The list moved to its own page; two editors for one table only confuse. */}
      <h3 className="font-semibold mb-1">{t("nav_finMethods")}</h3>
      <p className="text-sm text-slate-500 mb-10">
        <a href="/methods" className="text-blue-600 font-medium">{t("nav_finMethods")} →</a>
      </p>
